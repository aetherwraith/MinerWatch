    ...
    async def eval_miner_now(self, miner_id: int) -> None:
        ...
        if m and _coerce_bool(m.get("guardian_enabled")):
            ...
            if sample:
                ...
                if drv.can_set_fan and fan_mode == "minerwatch":
        ...
        if voltage_on:
            ...
            if drv.can_set_voltage and drv.can_set_frequency:
                ...
                tf, tv, vreason = decide_point(
                    ...
                    floor_mhz=floor,
                    volt_ceiling_mv=int(miner.get("guardian_max_voltage_mv") or gcfg.v2_voltage_ceiling_mv),
                    volt_floor_mv=int(miner.get("guardian_voltage_floor_mv") or miner.get("guardian_min_voltage_mv") or gcfg.v2_voltage_floor_mv),
